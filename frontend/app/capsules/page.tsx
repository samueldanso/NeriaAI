			...
			<nav className="bg-white border-b">
				<div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
					<div>
						...
						<p className="text-sm text-gray-600">Human–AI Knowledge Reasoning</p>
					</div>
			...
			<div className="max-w-6xl mx-auto p-8">
				...
				<div className="mb-8">
					...
					<p className="text-gray-600">
						Browse verified knowledge created by AI agents and validated by human
						experts
					</p>
				</div>
					...
					<div className="flex items-start gap-3">
						...
						<div>
							...
							<p className="text-sm text-gray-700">
								This page shows example capsules. In Phase 2, real capsules will be
								created when queries are validated by human experts via ASI:One.
							</p>
						</div>
					</div>
				</div>
						...
						>
							<div className="flex items-start justify-between mb-3">
								<div className="flex-1">
									<h3 className="font-semibold text-lg mb-2">{capsule.query}</h3>
								...
								>
									{capsule.status === 'validated' ? '✅ Validated' : '⏳ Pending'}
								</span>
							</div>
				...
				<div className="mt-12 bg-white border rounded-lg p-8">
					<h3 className="text-xl font-bold mb-4">How Knowledge Capsules Work</h3>
					<div className="space-y-4 text-sm text-gray-700">
						<div className="flex gap-3">
							<span className="font-bold text-blue-600">1.</span>
							<div>
								<strong>Query Submission:</strong> A user asks a complex question
								through the NERIA AI interface
							</div>
						</div>
						<div className="flex gap-3">
							<span className="font-bold text-blue-600">2.</span>
							<div>
								<strong>AI Reasoning:</strong> uAgents and MeTTa analyze the query
								and create a structured reasoning chain
							</div>
						</div>
						<div className="flex gap-3">
							<span className="font-bold text-blue-600">3.</span>
							<div>
								<strong>Human Validation:</strong> The reasoning is sent to domain
								experts via ASI:One for review
							</div>
						</div>
						<div className="flex gap-3">
						...
						<div className="flex gap-3">
							...
							<div>
								<strong>Reusability:</strong> Future queries can reference existing
								capsules, building on verified knowledge
							</div>
						</div>
					</div>
				</div>
